...
HD_PWD='E:/A_Projet_Stage/NovelMedical_Intership_project/NovelMedical_Intership_project.runs/design_1_Psudo_OLED_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_Psudo_OLED_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_Psudo_OLED_0_0.tcl
