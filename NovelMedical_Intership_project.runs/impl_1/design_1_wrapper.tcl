...
set rc [catch {
  ...
  update_ip_catalog
  set_property ip_output_repo E:/A_Projet_Stage/NovelMedical_Intership_project/NovelMedical_Intership_project.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_MEMORY} [current_project]
  add_files -quiet E:/A_Projet_Stage/NovelMedical_Intership_project/NovelMedical_Intership_project.runs/synth_1/design_1_wrapper.dcp
